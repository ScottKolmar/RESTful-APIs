...
parser.add_argument("-n", "--containername", help="Docker Container Name", required=False, default = "Chemical Transformation Database")
...
docker_run = f'docker run --name {args.containername} -e FLASK_APP=/app/flask-api/main.py' + ' -e PYTHONPATH=${PYTHONPATH}:/app/flask-api/' + f' -p {args.port}:5000 -d -it {image}'
